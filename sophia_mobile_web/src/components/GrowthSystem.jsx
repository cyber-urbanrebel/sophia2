...
const GrowthSystem = () => {
  ...
  return (
    <div style={{ padding: '0', color: '#fff', background: 'transparent', fontFamily: '"DM Mono", monospace', paddingBottom: '40px' }}>
      <h2 style={{ fontSize: '24px', marginBottom: '24px', color: '#00d4ff' }}>🏆 Growth & Achievements</h2>

      {/* Level Display */}
      <div style={{ background: '#111111', border: '1px solid #222222', borderRadius: '12px', padding: '24px', marginBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          <div style={{ fontSize: '64px', fontWeight: 'bold', color: '#00d4ff', minWidth: '100px' }}>
            LVL {profile.level}
          </div>
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: '18px', marginBottom: '8px', color: '#00d4ff' }}>{getLevel(profile.level)}</p>
            <div style={{ background: '#0a0a0a', height: '8px', borderRadius: '4px', overflow: 'hidden', marginBottom: '8px' }}>
              <div style={{ background: '#00d4ff', height: '100%', width: `${(profile.xp / profile.nextLevelXp) * 100}%`, transition: 'width 0.3s' }} />
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '12px', marginBottom: '20px' }}>
        <div style={{ background: '#111111', border: '1px solid #222222', borderRadius: '12px', padding: '16px', textAlign: 'center' }}>
          <p style={{ color: '#888', fontSize: '12px', marginBottom: '8px' }}>Total XP</p>
          <p style={{ fontSize: '24px', color: '#00e676', fontWeight: 'bold' }}>{profile.totalXp}</p>
        </div>
        <div style={{ background: '#111111', border: '1px solid #222222', borderRadius: '12px', padding: '16px', textAlign: 'center' }}>
          <p style={{ color: '#888', fontSize: '12px', marginBottom: '8px' }}>Current Streak</p>
          <p style={{ fontSize: '24px', color: '#ffaa00', fontWeight: 'bold' }}>🔥 {profile.streak}</p>
        </div>
        <div style={{ background: '#111111', border: '1px solid #222222', borderRadius: '12px', padding: '16px', textAlign: 'center' }}>
